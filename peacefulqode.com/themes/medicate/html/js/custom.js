  ...
  jQuery(window).on("load", function (e) {
    ...
    jQuery(".pq-applyform .form-btn").click(function () {
      ...
      /* if (email == "" || email == undefined) {
        ...
        ).insertAfter(".pq-bg-white .pq-applyform .e-mail-field");
        result = false;
      } else {
      ...
      if (email == "" || email == undefined) {
        jQuery(
          "<span class='pq-email-error-message pq-message'>Please fill the field</span>"
        ).insertAfter(".pq-formbox .pq-applyform .e-mail-field");
        result = false;
      } else {
        jQuery(".pq-email-error-message").remove();
        result = true;
      ...
      if (email == "" || email == undefined) {
        jQuery(
          "<span class='pq-email-error-message pq-message'>Please fill the field</span>"
        ).insertAfter(".pq-applyform-white-bg .pq-applyform .e-mail-field");
        result = false;
      } else {
        jQuery(".pq-email-error-message").remove();
        result = true;
      ...
      if (email == "" || email == undefined) {
        jQuery(
          "<span class='pq-email-error-message pq-message'>Please fill the field</span>"
        ).insertAfter(".pq-form-container .pq-applyform .e-mail-field");
        result = false;
      } else {
        jQuery(".pq-email-error-message").remove();
        result = true;
      ...
      if (email == "" || email == undefined) {
        jQuery(
          "<span class='pq-email-error-message pq-message'>Please fill the field</span>"
        ).insertAfter(".appoinment-box .pq-applyform .e-mail-field");
        result = false;
      } else {
        jQuery(".pq-email-error-message").remove();
        result = true;
      ...
      if (email == "" || email == undefined) {
        jQuery(
          "<span class='pq-email-error-message pq-message'>Please fill the field</span>"
        ).insertAfter(".comment-form .e-mail-field");
        result = false;
      } else {
        jQuery(".pq-email-error-message").remove();
        result = true;
      ...
      if (email == "" || email == undefined) {
        jQuery(
          "<span class='pq-email-error-message pq-message'>Please fill the field</span>"
        ).insertAfter(".get-in-touch .e-mail-field");
        result = false;
      } else {
        jQuery(".pq-email-error-message").remove();
        result = true;
      ...
      if (patient_name == "" || patient_name == undefined) {
        ...
        ).insertAfter(".pq-applyform .pq-appointment .paitent-name-field");
        result = false;
      } else {
      ...
      if (result == true) {
        jQuery(
          "<span class='pq-thank-you-message pq-text-dark ms-5'> Thank You For Filling The form</span>"
        ).insertAfter(".pq-bg-white .pq-applyform .pq-button");
      }
    });
    ...
    jQuery(".pq-applyform #form-btn").click(function () {
      ...
      if (result == true) {
        jQuery(
          "<span class='pq-thank-you-message pq-text-dark ms-3'>Thank You</span>"
